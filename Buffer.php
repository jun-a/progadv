 ...
 * String Buffer class.
 * 
 * It tries to mimic the java StringBuffer class
 * 
 * @package String
...
class String_Buffer {
     ...
     * @return void
     */
    public function set_length($new_length) {
     ...
     * @return void
     */
    public function get_chars($src_begin, $src_end, &$dst, $dst_begin) {
        if($src_begin < 0) {
     ...
     * @return void
     */
    public function set_char_at($idx, $chr) {
        if($idx < 0 || $idx > $this->length()) {
            throw new OutOfBoundsException("Index out of bounds.");
        }
    ...
    private function &check_append(&$arg) {
        ...
        if($arg instanceof String_Buffer) {
    ...
    /**
     * Appends the specified String_Buffer to this String_Buffer.
     * 
     * The characters of the String_Buffer argument are appended, in order, to
     * the contents of this String_Buffer, increasing the length of this 
     * String_Buffer by the length of the argument.
     * 
     * @access private
     * 
     */
    ...
    /**
     * Removes the characters in a substring of this String_Buffer. The substring
     * begins at the specified $start and extends to the charactar index $end - 1
     * or to the end of the String_Buffer if no such character exists. If $start 
    ...
    /**
     * Removes the character at the specified position in this String_Buffer
    ...
    /**
     * Replaces the characters in a substring of this String_Buffer with 
     ...
     * end of the String_Buffer if no such character exists. First the characters 
     * in the substring are removed and then the specified $str string is 
     * inserted at $start. (The String_Buffer will be lengthened to accomodate 
     ...
     * currently contained in this String_Buffer. The substring begins at the
     * specified $start index and extends to the end of the String_Buffer.
     * 
     * @access public
     * @param integer $start The beginning index, inclusive. 
     * @throws OutOfBoundsException
     * @return string
     */
    public function sub_string($start, $end = null) {
        $start = intval($start);
    ...
    /**
     * Insert the string $str into this String_Buffer.
     * 
    ...
    public function index_of($str, $idx = 0) {
        $index = mb_strpos($this->__toString(), $str, $idx, "UTF-8");
    ...
    public function last_index_of($str, $offset = 0) {
        ...
        $index = mb_strrpos($this->__toString(), $str, $offset, "UTF-8");
